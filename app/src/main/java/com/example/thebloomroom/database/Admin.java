...
public class Admin {
    ...
    // Parameterized constructor to initialize an Admin object with provided values
    public Admin(String name, String email, String password, String repeat_Password) {
        Name = name;
        Email = email;
        Password = password;
    ...
    // Default constructor to initialize an empty Admin object
    public Admin() {
        Name = "";
        Email = "";
        Password = "";
